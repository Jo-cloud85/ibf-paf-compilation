...
public class RSVP {
    ...
    public String toString() {
        return "RSVP [id=" + id + ", name=" + name + ", email=" + email + ", phone=" + phone + ", confirmationDate="
                + confirmationDate + ", comments=" + comments + ", foodType=" + foodType + ", totalCnt=" + totalCnt
                + "]";
    }
    ...
    public static RSVP create(JsonObject readObject){
        ...
        rsvp.setFoodType(readObject.getString("foodType"));
        // json return date -> retrieve as string 
        //-> parse using Instant -> set to your pojo/object
        rsvp.setConfirmationDate(new DateTime(
            Instant.parse(readObject.getString("confirmationDate"))));
        return rsvp;
    }
